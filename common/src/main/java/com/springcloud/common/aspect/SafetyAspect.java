...
import com.springcloud.common.annotation.Decrypt;
import com.springcloud.common.annotation.Encrypt;
import com.springcloud.common.result.Response;
import com.springcloud.common.result.ResultEnum;
import com.springcloud.common.util.AesUtil;
import com.springcloud.common.util.RsaUtil;
...
public class SafetyAspect {
     ...
     */
    @Pointcut(value = "execution(public * cn.lmn.*.controller.*.*(..)) || " +
            "execution(public * com.springcloud.*.controller.*.*(..))")
    ...
    public Object around(ProceedingJoinPoint pjp) {
        try {
            ...
            if (hasEncrypt) {
                ...
                o =  Response.ok(mapper.readValue("{\"data\":\"" + data + "\",\"aesKey\":\"" + aesKey + "\"}", Object.class));
            }
            ...
            return Response.error(ResultEnum.ERROR,"加解密异常：\n\t" + e.getMessage());
        }
    }
}
